...
Route::get('/', [MapController::class, 'index'])->name('index'); //index pada mapcontroller berfungsi untuk identifikasi function 'index' pada MapController,sedangkan name->index berfungsi untuk menentukan route yang diakses
Route::get('/table', [MapController::class, 'table'])->name('table'); //index pada mapcontroller berfungsi untuk identifikasi function 'index' pada MapController,sedangkan name->index berfungsi untuk menentukan route yang diakses
